...
export const markopolos: Story = {
  ...
  subtitle: 'One analyst proved Bernie Madoff was a fraud in an afternoon. The regulator ignored him for nine years.',
  hook: 'The largest financial fraud in history was not hidden. One man found it in an afternoon, told the regulator, and was ignored for nearly a decade.',
  era: 'contemporary',
  years: [1999, 2009],
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'One man did the math and knew it was a fraud in an afternoon.' },
    { beat: 'hook', text: 'He told the regulator. Then told them again. For nine years.' },

    { beat: 'worldBefore', kicker: '1999', text: 'Bernie Madoff runs the most trusted money in America.' },
    { beat: 'worldBefore', text: 'A former NASDAQ chairman. His fund never has a bad year.' },
    { beat: 'worldBefore', text: 'Steady returns, month after month, in every market.' },
    { beat: 'worldBefore', punch: true, text: 'That was the problem.' },

    { beat: 'problem', text: 'Harry Markopolos is asked to copy Madoff’s strategy for a rival firm.' },
    { beat: 'problem', text: 'He is a numbers man. He starts with the returns.' },
    { beat: 'problem', punch: true, mark: 'toosmooth', text: 'Real returns are jagged. Madoff’s went up in a straight line.' },

    { beat: 'story', text: 'So he checks the strategy Madoff claims to use.' },
    { beat: 'story', text: 'It needs options on the S&P 100, bought and sold in enormous volume.' },
    { beat: 'story', punch: true, mark: 'imbalance', text: 'More options than existed in the entire market.' },
    { beat: 'story', text: 'The trades Madoff claimed to make could not have happened.' },
    { beat: 'story', punch: true, text: 'He was not trading at all.' },
    { beat: 'story', text: 'New investors’ money was paying old investors. A Ponzi scheme.' },
    { beat: 'story', kicker: '2000', text: 'Markopolos takes it to the SEC.' },
    { beat: 'story', text: 'They pass. He submits again. And again.' },
    { beat: 'story', kicker: '2005', punch: true, text: '"The World’s Largest Hedge Fund Is a Fraud."' },

    { beat: 'whyItHappened', text: 'The SEC investigates Madoff. More than once.' },
    { beat: 'whyItHappened', punch: true, text: 'And clears him every time.' },
    { beat: 'whyItHappened', text: 'No one there could follow the math he had sent them.' },
    { beat: 'whyItHappened', text: 'And you do not accuse a legend.' },
    { beat: 'whyItHappened', text: 'Markopolos was a rival. Easy to wave away as sour grapes.' },
    { beat: 'whyItHappened', mark: 'echo', text: 'So the warning kept arriving, and kept being filed away.' },

    { beat: 'consequences', kicker: '2008', text: 'Then the crash hits. Everyone wants their money back at once.' },
    { beat: 'consequences', mark: 'collapse', text: 'New money stops. There is nothing behind the statements.' },
    { beat: 'consequences', punch: true, text: 'Madoff confesses to his sons. It is over.' },
    { beat: 'consequences', text: 'The statements said $65 billion. Most of it never existed.' },

    { beat: 'whyItMatters', text: 'The story is not that no one caught Bernie Madoff.' },
    { beat: 'whyItMatters', punch: true, text: 'Someone did. In an afternoon, nine years early. And nothing changed.' },
  ],
