...
export const markopolos: Story = {
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'The biggest fraud in history was never hidden. One man saw it in an afternoon.' },
    { beat: 'hook', text: 'Then spent nine years being right, and ignored.' },
    { beat: 'worldBefore', kicker: '1999', text: 'Bernie Madoff is the most trusted name on Wall Street.' },
    { beat: 'worldBefore', text: 'A former NASDAQ chairman. A fund that never has a bad month.' },
    { beat: 'worldBefore', text: 'Returns that only ever go up.' },
    { beat: 'worldBefore', punch: true, text: 'That is not success. That is the tell.' },
    { beat: 'problem', text: 'Harry Markopolos is asked to copy the strategy for a rival.' },
    { beat: 'problem', text: 'He is a numbers man. He starts with the returns.' },
    { beat: 'problem', punch: true, mark: 'toosmooth', text: 'Real returns are jagged. Madoff’s climb in a straight line.' },
    { beat: 'problem', punch: true, text: 'No market moves like that, because no market is that kind.' },
    { beat: 'story', text: 'So he checks the strategy Madoff claims to run.' },
    { beat: 'story', text: 'It needs options on the S&P 100, in enormous amounts.' },
    { beat: 'story', punch: true, mark: 'imbalance', text: 'More than exist in the entire market.' },
    { beat: 'story', text: 'The trades he claims to make cannot have happened.' },
    { beat: 'story', punch: true, text: 'He is not trading at all.' },
    { beat: 'story', text: 'New money is paying the old. A Ponzi scheme, behind a famous name.' },
    { beat: 'story', kicker: '2000', text: 'Markopolos takes it to the SEC. Then again. And again.' },
    { beat: 'story', kicker: '2005', punch: true, text: '"The World’s Largest Hedge Fund Is a Fraud."' },
    { beat: 'whyItHappened', text: 'The regulator investigates Madoff. More than once.' },
    { beat: 'whyItHappened', punch: true, text: 'And clears him every time.' },
    { beat: 'whyItHappened', text: 'No one there could follow the math he had sent.' },
    { beat: 'whyItHappened', text: 'And you do not accuse a legend on a stranger’s word.' },
    { beat: 'whyItHappened', mark: 'echo', text: 'So the warning arrived, was filed, and arrived again.' },
    { beat: 'whyItHappened', punch: true, text: 'The hard part is never seeing it. It is being believed.' },
    { beat: 'consequences', kicker: '2008', text: 'Then the crash. Everyone wants their money back at once.' },
    { beat: 'consequences', mark: 'collapse', text: 'The new money stops. There is nothing behind the statements.' },
    { beat: 'consequences', punch: true, text: 'Madoff confesses. The statements said $65 billion.' },
    { beat: 'consequences', text: 'Most of it never existed.' },
    { beat: 'whyItMatters', text: 'The comforting story is that no one could have known.' },
