...
export const alKhwarizmi: Story = {
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'Every machine on earth runs on one word. The word is a man’s name.' },
    { beat: 'hook', text: 'He died twelve hundred years ago. Scribes spelled him wrong, and it stuck.' },
    { beat: 'worldBefore', text: 'Try multiplying 148 by 39 in Roman numerals. CXLVIII by XXXIX.' },
    { beat: 'worldBefore', text: 'You cannot. No columns. No symbol for nothing.' },
    { beat: 'worldBefore', punch: true, text: 'So arithmetic is not something you do. It is someone you hire.' },
    { beat: 'problem', kicker: '762', text: 'Baghdad rises from nothing — a perfect circle, the largest city on earth.' },
    { beat: 'problem', text: 'An empire that size runs on numbers, and on one problem in every town.' },
    { beat: 'problem', text: 'Inheritance. Exact fractions, fixed by law.' },
    { beat: 'problem', punch: true, text: 'Get it wrong and it is not a mistake. It is an injustice.' },
    { beat: 'story', kicker: 'around 820', text: 'A scholar named al-Khwārizmī writes a book to fix it.' },
    { beat: 'story', text: 'Two moves. Restore what was taken. Balance what is left.' },
    { beat: 'story', text: 'In Arabic, the first move is al-jabr.' },
    { beat: 'story', punch: true, mark: 'chain', text: 'al-jabr → algebra.' },
    { beat: 'story', text: 'No x. No equals sign. Those come centuries later, in Europe.' },
    { beat: 'story', text: 'Every equation is a sentence. Every proof, a drawing.' },
    { beat: 'story', punch: true, text: 'He did not solve a problem. He solved every problem of that shape.' },
    { beat: 'whyItHappened', text: 'He says plainly why he wrote it. Not for beauty.' },
    { beat: 'whyItHappened', punch: true, text: 'For inheritance, trade, digging canals. Algebra was built for paperwork.' },
    { beat: 'consequences', text: 'Then a second book. Indian digits, place value, and a small circle.' },
    { beat: 'consequences', punch: true, text: 'Zero.' },
    { beat: 'consequences', text: 'Every Arabic copy of it is lost. All of them.' },
    { beat: 'consequences', text: 'A Latin translation survives. It opens: Dixit Algoritmi.' },
    { beat: 'consequences', text: '"Al-Khwārizmī said."' },
    { beat: 'consequences', punch: true, text: 'Readers thought it named the method. It named the man.' },
    { beat: 'whyItMatters', text: 'That is where the word "algorithm" comes from.' },
    { beat: 'whyItMatters', text: 'Steps so exact you need not understand them to follow them —' },
    { beat: 'whyItMatters', punch: true, mark: 'echo', text: 'which is the only reason a machine ever could.' },
  ],
