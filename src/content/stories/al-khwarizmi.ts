...
export const alKhwarizmi: Story = {
  ...
  reel: [
    ...
    { beat: 'worldBefore', text: 'You cannot. There are no columns. There is no symbol for nothing.' },
    ...
    { beat: 'story', text: 'Here is the strange part. There is no x in it. No equals sign.' },
    ...
    { beat: 'consequences', text: 'A Latin translation survives. It opens: Dixit Algoritmi. Al-Khwārizmī said.' },
