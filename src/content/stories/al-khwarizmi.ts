...
export const alKhwarizmi: Story = {
  slug: 'al-khwarizmi',
  title: 'The Man Who Became a Word',
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'Every machine on earth runs on one word, and the word is a man’s name.' },
    { beat: 'hook', text: 'He died twelve hundred years ago, and scribes spelled him wrong.' },
    { beat: 'worldBefore', text: 'Try multiplying 148 by 39 in Roman numerals — CXLVIII by XXXIX.' },
    { beat: 'worldBefore', text: 'You cannot, because there are no columns to line up' },
    { beat: 'worldBefore', text: 'and no symbol at all for nothing,' },
    { beat: 'worldBefore', punch: true, text: 'so arithmetic is not something you do. It is someone you hire.' },
    { beat: 'problem', kicker: '762', text: 'Then Baghdad rises out of empty ground, a perfect circle,' },
    { beat: 'problem', text: 'the largest city on earth, running an empire on numbers,' },
    { beat: 'problem', text: 'and every town in it has the same problem waiting: inheritance,' },
    { beat: 'problem', text: 'exact fractions, fixed by law, on every death,' },
    { beat: 'problem', punch: true, text: 'where getting it wrong is not a mistake but an injustice.' },
    { beat: 'story', kicker: 'around 820', text: 'So a scholar named al-Khwārizmī writes a book to fix it,' },
    { beat: 'story', text: 'and the whole method comes down to two moves —' },
    { beat: 'story', text: 'restore what was taken away, then balance what is left.' },
    { beat: 'story', text: 'In Arabic the first of those moves is al-jabr,' },
    { beat: 'story', punch: true, mark: 'chain', text: 'al-jabr → algebra.' },
    { beat: 'story', text: 'There is no x in it, no equals sign, no notation of any kind;' },
    { beat: 'story', text: 'every equation is a sentence and every proof is a drawing.' },
    { beat: 'story', punch: true, text: 'He did not solve a problem. He solved every problem of that shape.' },
    { beat: 'whyItHappened', text: 'And he says plainly why he wrote it — not for beauty' },
    { beat: 'whyItHappened', punch: true, text: 'but for inheritance, trade and digging canals. Algebra was built for paperwork.' },
    { beat: 'consequences', text: 'Then he writes a second book, on Indian digits and place value' },
    { beat: 'consequences', text: 'and a small circle standing for nothing at all,' },
    { beat: 'consequences', punch: true, text: 'which is how Europe eventually gets zero.' },
    { beat: 'consequences', text: 'Every Arabic copy of that book is lost — all of them —' },
    { beat: 'consequences', text: 'and only a Latin translation survives, opening on two words:' },
    { beat: 'consequences', text: 'Dixit Algoritmi. Al-Khwārizmī said.' },
    { beat: 'consequences', punch: true, text: 'Readers took it for the name of the method. It was the name of the man.' },
    { beat: 'whyItMatters', text: 'That is where algorithm comes from — steps so exact' },
    { beat: 'whyItMatters', punch: true, mark: 'echo', text: 'that you need not understand them to follow them, which is the only reason a machine ever could.' },
  ],
