...
export const opiumWars: Story = {
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'An empire went to war to keep selling a drug, and called the war something else.' },
    { beat: 'hook', text: 'It begins with tea.' },
    { beat: 'worldBefore', kicker: '1750', text: 'China makes the best silk, the best porcelain and the best tea on earth,' },
    { beat: 'worldBefore', text: 'and wants nothing Britain can put on a ship in return —' },
    { beat: 'worldBefore', text: 'not the wool, not the clocks, not the iron.' },
    { beat: 'worldBefore', punch: true, text: 'There is one thing it will take. Silver.' },
    { beat: 'problem', text: 'So silver sails east and tea sails west, and every year' },
    { beat: 'problem', mark: 'drain', text: 'a little more of Britain’s money stays in Canton and never comes home,' },
    { beat: 'problem', text: 'while the tax on tea is what pays for the navy.' },
    { beat: 'problem', text: 'Britain needs one thing China will actually buy,' },
    { beat: 'story', punch: true, text: 'and it already grows it, in India. Opium.' },
    { beat: 'story', text: 'China banned the stuff in 1729, which is not the obstacle —' },
    { beat: 'story', punch: true, text: 'it is the reason the price is so good.' },
    { beat: 'story', text: 'So the Company grows the opium, auctions the chests in Calcutta,' },
    { beat: 'story', text: 'and lets other men do the smuggling.' },
    { beat: 'story', kicker: '1838', mark: 'spike', text: 'Forty thousand chests a year, into a country where it is illegal,' },
    { beat: 'story', kicker: '1839', text: 'until China sends its most incorruptible official to end it.' },
    { beat: 'story', text: 'Lin Zexu destroys a thousand tonnes and writes to Queen Victoria,' },
    { beat: 'story', text: 'asking how a country that bans opium at home can send it abroad.' },
    { beat: 'story', punch: true, text: 'No one is sure she ever read it.' },
    { beat: 'whyItHappened', text: 'Then one official in Canton promises the smugglers' },
    { beat: 'whyItHappened', text: 'that the Crown will cover whatever they have lost,' },
    { beat: 'whyItHappened', punch: true, mark: 'reversal', text: 'and in an afternoon a drug debt becomes a national one,' },
    { beat: 'whyItHappened', punch: true, text: 'because a debt is far easier to defend than a drug.' },
    { beat: 'whyItHappened', kicker: '1840', text: 'Parliament votes for war by nine votes.' },
    { beat: 'consequences', text: 'Britain never marches on Beijing — it cuts the canal that feeds it,' },
    { beat: 'consequences', kicker: '1842', text: 'and takes five ports, an enormous indemnity, and one rocky island' },
    { beat: 'consequences', punch: true, text: 'that nobody in London thought was worth much. Hong Kong.' },
    { beat: 'consequences', text: 'The treaty does not mention opium once.' },
    { beat: 'whyItMatters', punch: true, text: 'China calls the century that follows its Humiliation, and it is still answering 1840.' },
  ],
