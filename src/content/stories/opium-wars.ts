...
export const opiumWars: Story = {
  ...
  reel: [
    ...
    { beat: 'worldBefore', text: 'Britain turns up at Canton with wool to sell.' },
    ...
    { beat: 'problem', punch: true, text: 'The silver keeps leaving. Every single year.' },
    ...
    { beat: 'story', kicker: '1838', punch: true, text: 'Forty thousand chests a year. Over two thousand tonnes, into a country where it is illegal.' },
    ...
    { beat: 'whyItHappened', punch: true, text: 'In an afternoon, a smugglers’ loss becomes a government debt.' },
