...
export const opiumWars: Story = {
  ...
  reel: [
    { beat: 'hook', punch: true, text: 'Britain started a war because it could not stop drinking tea.' },
    { beat: 'worldBefore', kicker: '1750', text: 'China makes the best silk, porcelain and tea on earth.' },
    { beat: 'worldBefore', mark: 'gate', text: 'Britain turns up at Canton with wool to sell.' },
    { beat: 'worldBefore', text: 'China does not want wool. It rains differently in Guangdong.' },
    { beat: 'problem', text: 'There is one thing China will take. Silver.' },
    { beat: 'problem', text: 'So for a century, ships sail east full of silver and come home full of tea.' },
    { beat: 'problem', punch: true, mark: 'drain', text: 'The silver keeps leaving. Every single year.' },
    { beat: 'problem', text: 'And the tax on tea is one of the British government’s most reliable incomes. It is paying for warships.' },
    { beat: 'problem', text: 'Britain needs something — anything — China will actually buy.' },
    { beat: 'story', step: 1, text: 'Find something they cannot say no to.' },
    { beat: 'story', punch: true, text: 'The East India Company already grows it. In India. Opium.' },
    ...
    { beat: 'story', kicker: '1838', punch: true, mark: 'spike', text: 'Forty thousand chests a year. Over two thousand tonnes, into a country where it is illegal.' },
    { beat: 'story', step: 2, text: 'Make sure it is never legally yours.' },
    { beat: 'story', kicker: '1839', text: 'China sends its most incorruptible official, Lin Zexu, to end it.' },
    { beat: 'story', text: 'He seizes 20,283 chests, dissolves them in salt and lime, and flushes a thousand tonnes into the sea.' },
    { beat: 'story', text: 'He writes to Queen Victoria. Opium is banned in your country too. How can you send it to mine?' },
    { beat: 'story', punch: true, text: 'There is no evidence she ever read it.' },
    { beat: 'whyItHappened', step: 3, text: 'When they fight back, make it the taxpayer’s problem.' },
    { beat: 'whyItHappened', text: 'Then one British official does the thing that starts the war.' },
    { beat: 'whyItHappened', text: 'He tells the merchants to hand their opium over — and promises the Crown will pay them back for it.' },
    { beat: 'whyItHappened', punch: true, mark: 'reversal', text: 'In an afternoon, a smugglers’ loss becomes a government debt.' },
    { beat: 'whyItHappened', text: 'Now Parliament is not defending drug dealers. It is defending the Treasury.' },
    { beat: 'whyItHappened', kicker: 'April 1840', text: 'They vote for war. It passes by nine votes.' },
    { beat: 'consequences', step: 4, text: 'Send the gunboats, and write the treaty yourself.' },
    { beat: 'consequences', text: 'Britain does not march on Beijing. It sails up the Yangtze and cuts the canal that feeds the capital.' },
    { beat: 'consequences', text: 'China surrenders in six weeks.' },
    { beat: 'consequences', kicker: '1842', text: 'Five ports opened. Twenty-one million silver dollars. And one rocky island with a very good harbour.' },
    { beat: 'consequences', punch: true, text: 'That island was Hong Kong.' },
    { beat: 'consequences', text: 'The treaty does not mention opium once.' },
    { beat: 'whyItMatters', text: 'China calls the hundred years that follow the Century of Humiliation.' },
    { beat: 'whyItMatters', text: 'Its schools still teach modern history as starting right here.' },
    {
      beat: 'whyItMatters',
      punch: true,
      text: 'Every time China refuses to open on someone else’s terms, it is answering a fleet that showed up in 1840.',
    },
  ],
