...
export const opiumWars: Story = {
  ...
  reel: [
    ...
    { beat: 'problem', text: 'The tax on tea is paying for the navy.' },
    ...
    { beat: 'story', text: 'So the Company never smuggles. It grows the opium and auctions it in Calcutta.' },
    ...
    { beat: 'story', text: 'He writes to Queen Victoria. Opium is banned in your country too.' },
